...
class RobertaConfig(PretrainedConfig):
    ...
    Args:
        ...
        plpi_affinity_function (`str`, *optional*, defaults to `"vanilla"`):
            Type of attention head. Choose one of `"vanilla"`, `"pairwise"`, `"symmetric"`.
    ...
    def __init__(
        ...
        plpi_affinity_function="vanilla",
        **kwargs,
    ):
        super().__init__(
